...
export default function ProductsTable({
  ...
  const handleQuantityChange = (productId: string, newQuantity: number) => {
    ...
    setPendingChanges((current) => {
      const existingChangeIndex = current.findIndex(
        ...
        <table className="w-full">
          <thead>
            <tr className="bg-indigo-50">
              <th
                scope="col"
                className="px-6 py-4 text-left text-sm font-semibold text-indigo-900"
              >
                ID
              </th>
              <th
              ...
              return (
                  ...
                  <tr
                    ...
                    className={`transition-colors hover:bg-gray-50/50 ${
                      hasChange ? "bg-blue-50/50" : ""
                    }`}
                  >
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                      {product._id}
                    </td>
                    <td className="px-6 py-4 hover:text-purple-500 transition-colors whitespace-nowrap text-sm font-medium text-gray-800">
                      <Link href={`products/${product._id}`}>{product.label}</Link>
                    </td>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="p-1  text-gray-600 cursor-pointer hover:text-gray-800 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        ...
                        <span
                          className={`w-12 text-center text-black font-medium ${
                            hasChange ? "text-blue-600" : ""
                          }`}
                        >
                          {currentQuantity}
                        </span>
                        <button
                          ...
                          className="p-1 text-gray-600 cursor-pointer hover:text-gray-800 transition-colors"
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <div className="flex items-center gap-3">
                        <button
                          ...
                          className="p-1 text-blue-600 cursor-pointer hover:text-blue-800 transition-colors"
                          title="Edit product"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        <button
                          ...
                          className="p-1 text-red-600 cursor-pointer hover:text-red-800 transition-colors"
